...
{
	$sql = "select * from attendance_log where attend_date >= :attend_date";
...
?>
<form method = "post">
<p>Enter Date after which Attendance of Gardeners is to be Fetched: <input type = "date" name = "attend_date" value = "" ></p>
